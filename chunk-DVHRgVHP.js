import{t as Dc}from"./main-PWHTNJJJ.js";function S(i,e){let n=i.split(`
...
`).trimEnd();u.trim()!==``?n.push({type:`text`,text:u,startLine:f,endLine:t-1}):t++}return n}function w(i){return{filename:`${(i.title.trim()||`Untitled`).replace(/[\\/:*?"<>|]/g,`_`)}.txt`,content:Dc(i.body)}}function y(i){let e=`# Lichen Notes Export
# version: 1
